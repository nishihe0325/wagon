...
public interface CanalConnector {
    ...
    // =============================== extend command ========================================
    CanalDBSwitchResult canalDBSwitch(CanalDBSwitchRequestData data) throws CanalClientException;
   
    CanalServerRunningData queryCanalRunningInfo(String destination) throws CanalClientException;
    
    TablePositionData queryTablePosition(String tableName) throws CanalClientException;
