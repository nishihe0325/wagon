 ...
 * @version 1.0.0
 */
public class CanalController implements CanalControllerInterface {
    ...
    protected CanalServerWithEmbedded                embededCanalServer;
    ...
    public CanalController(final Properties properties){
        ...
        managerAddr = getProperty(properties, "console.address");
        serviceName = getProperty(properties, "service.name");
        assert managerAddr != null;
            ...
            instanceConfigMonitors = MigrateMap.makeComputingMap(new Function<InstanceMode, InstanceConfigMonitor>() {
                ...
                public InstanceConfigMonitor apply(InstanceMode mode) {
                    ...
                    if (mode.isSpring()) {
                        ...
                        return new ManagerInstanceConfigMonitor(null, defaultAction, null);
                    } else {
        ...
        instanceGenerator = new CanalInstanceGenerator() {
            ...
            public CanalInstance generate(String destination) {
                ...
                if (config.getMode().isManager()) {
                    return ManagerCanalInstanceGenerator.getInstance().generate(destination);
