...
public class SessionHandler extends SimpleChannelHandler {
    ...
    private ExtendCommandHandler extendCommandHandler;
    ...
    public SessionHandler(CanalServerWithEmbedded embeddedServer){
        ...
        this.extendCommandHandler =  new ExtendCommandHandler(this.embeddedServer);
    }

    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception {
        logger.debug("message receives in session handler...");
        ...
        try {
            switch (packet.getType()) {
                ...
                case CLIENTROLLBACK:
                    ...
                    break;
                case CMDEXTEND: // 扩展命令请求
                    extendCommandHandler.handleExtendCommand(CanalPacket.CmdExtend.parseFrom(packet.getBody()), ctx);
                    break;
                default:
