...
public class CanalServerWithEmbedded extends AbstractCanalLifeCycle implements CanalServer, CanalService {
    ...
    private CanalServerWithNetty canalServerWithNetty;
    ...
    public Message get(ClientIdentity clientIdentity, int batchSize, Long timeout, TimeUnit unit)
        ...
        synchronized (canalInstance) {
            ...
            if (CollectionUtils.isEmpty(events.getEvents())) {
                ...
                logger.debug("get successfully, clientId:{} batchSize:{} real size is {} and result is [batchId:{} , position:{}]",
                    clientIdentity.getClientId(),
                    batchSize,
                    entrys.size(),
                    batchId,
    ...
    public Message getWithoutAck(ClientIdentity clientIdentity, int batchSize, Long timeout, TimeUnit unit)
        ...
        synchronized (canalInstance) {
            ...
            if (CollectionUtils.isEmpty(events.getEvents())) {
                ...
                logger.debug("getWithoutAck successfully, clientId:{} batchSize:{}  real size is {} and result is [batchId:{} , position:{}]",
                    clientIdentity.getClientId(),
                    batchSize,
                    entrys.size(),
                    batchId,
    ...
    public CanalServerWithNetty getCanalServerWithNetty() {
        return canalServerWithNetty;
    }

    
    public void setCanalServerWithNetty(CanalServerWithNetty canalServerWithNetty) {
        this.canalServerWithNetty = canalServerWithNetty;
    }
